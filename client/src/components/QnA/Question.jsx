...
class Question extends React.Component {
  ...
  componentDidMount() {
    ...
    const allAnswers = [];
    axios.get(`http://ec2-34-204-68-14.compute-1.amazonaws.com:8080/qa/questions/${questionId}/answers`, {params: {page: 1, count: 5}})
      .then((answerList) => {
  ...
  addNewAnswer(answerBody, name, email, photos) {
    ...
    axios.post(`http://ec2-34-204-68-14.compute-1.amazonaws.com:8080/qa/questions/${questionId}/answers`, body.data)
      .then((result) => {
  ...
  yesHandler() {
    ...
    if (this.state.clickedYes === false) {
      ...
      const {formatBody} = this.props;
      const {question_id: questionId} = this.props.question;
      axios.put(`http://ec2-34-204-68-14.compute-1.amazonaws.com:8080/qa/questions/${questionId}/helpful`)
        .then((result) => {
